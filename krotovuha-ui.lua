-- // Lib \\ --
--[[
    local UI = loadstring(game:HttpGet("//abyss.best/assets/files/gayasf.ui2?key=5y1lxXSfWKhlQkSqhUuFyB8kPp8hsCau"))()
]]
-- // Library Init \\ --
local Start = tick()
local LoadTime = tick()
...
do
    function Library.CreateLoader(Title, WindowSize)
        ...
        --
        Library.Theme.Logo = Utility.AddImage("Abyss/Assets/UI/Logo2.png", "https://i.imgur.com/rDyoF59.png")
        --
